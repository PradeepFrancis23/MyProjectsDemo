...
class _HomeState extends State<Home> {
  ...
  getNewsByQuery(String query) async {
    String url =
        "https://newsapi.org/v2/everything?domains=wsj.com&apiKey=f36a0abbfbf9431fbed625784b7ead93";
  ...
  getNewsofIndia() async {
    String url =
        "https://newsapi.org/v2/everything?q=sports&from=2022-11-16&to=2022-11-16&sortBy=popularity&apiKey=f36a0abbfbf9431fbed625784b7ead93";
    Response response = await get(Uri.parse(url));
    Map data = jsonDecode(response.body);
    setState(() {
      data["articles"].forEach((element) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(" Bombay Times News"),
        centerTitle: true,
      ),
